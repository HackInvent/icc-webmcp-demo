...
| --- | --- | --- | --- |
| Native network | 21 Metro/RER lines, 390 stations, 467 interstations, 42 trains | Network overview, semantic zoom, incident-agent workflow | Separate telemetry and decision revisions |
...
The local catalogue contains 14 versioned procedures written for the operational
simulation.
...
> These documents are synthetic and written for the operational simulation. They
> are not official RATP, IDFM, infrastructure-manager, or regulatory instructions.
...
- the observation window declared by the retrieved procedure (commonly 30 or 60
  operational seconds in the accelerated simulation scenario).
...
simulation export, and the event journal is evidence generated by this environment, not an
