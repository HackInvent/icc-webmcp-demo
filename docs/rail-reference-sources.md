...
in the prototype; they are not live operational feeds.

## Sourced full-line facts

| Line | Facts represented in the prototype | Wikipedia source |
| --- | --- | --- |
...
separate scenario dates. The ×1/×2/×4 controls are demo accelerators rather than
real-time clock ratios.
