...
source code and automated tests remain the authority when a
...
| [webmcp-agent.md](webmcp-agent.md) | WebMCP transport, all 19 tools, incident protocol, and approval controls |
